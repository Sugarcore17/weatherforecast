...
public class WeatherWSLocator extends org.apache.axis.client.Service implements client.WeatherWS {
 ...
 */
    ...
    public client.WeatherWSSoap_PortType getWeatherWSSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public client.WeatherWSSoap_PortType getWeatherWSSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            client.WeatherWSSoap12Stub _stub = new client.WeatherWSSoap12Stub(portAddress, this);
    ...
    public client.WeatherWSSoap_PortType getWeatherWSSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public client.WeatherWSSoap_PortType getWeatherWSSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            client.WeatherWSSoap_BindingStub _stub = new client.WeatherWSSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (client.WeatherWSSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                client.WeatherWSSoap12Stub _stub = new client.WeatherWSSoap12Stub(new java.net.URL(WeatherWSSoap12_address), this);
                _stub.setPortName(getWeatherWSSoap12WSDDServiceName());
                return _stub;
            }
            if (client.WeatherWSSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                client.WeatherWSSoap_BindingStub _stub = new client.WeatherWSSoap_BindingStub(new java.net.URL(WeatherWSSoap_address), this);
                _stub.setPortName(getWeatherWSSoapWSDDServiceName());
                return _stub;
            }
        }
