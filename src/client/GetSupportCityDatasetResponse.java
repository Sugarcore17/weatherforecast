...
public class GetSupportCityDatasetResponse  implements java.io.Serializable {
    private client.GetSupportCityDatasetResponseGetSupportCityDatasetResult getSupportCityDatasetResult;

    public GetSupportCityDatasetResponse() {
    }

    public GetSupportCityDatasetResponse(
           client.GetSupportCityDatasetResponseGetSupportCityDatasetResult getSupportCityDatasetResult) {
     ...
     */
    public client.GetSupportCityDatasetResponseGetSupportCityDatasetResult getGetSupportCityDatasetResult() {
        return getSupportCityDatasetResult;
    }
     ...
     */
    public void setGetSupportCityDatasetResult(client.GetSupportCityDatasetResponseGetSupportCityDatasetResult getSupportCityDatasetResult) {
        this.getSupportCityDatasetResult = getSupportCityDatasetResult;
    }
